    ...
    return (
        <div className='bg-container-color border-t-[1px] h-auto pb-5 flex-center flex-col'>
            ...
            <div className='flex-center gap-5 mt-10 mob:mt-0'>
                <span className='bg-title p-2 rounded-lg  cursor-pointer'>  <FaGithub color='white' size={20} /></span>
                <span className='bg-title p-2 rounded-lg cursor-pointer'>  <a href="https://www.linkedin.com/in/hariom-gaud-aa5986206/"> <FaLinkedin color='white' size={20} /></a></span>
            </div>
